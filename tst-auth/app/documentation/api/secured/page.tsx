...
const ApiDocs = () => {
  const endpoints = [
    {
      method: 'GET',
      endpoint: '/api/secured/',
      description: 'Returns a static message. Used for checking if the authentication key correct and who the key belongs to',
      queryParams: [
      ...
      response: {
        ...
        account: "18222089@std.stei.itb.ac.id"
        // data: [
