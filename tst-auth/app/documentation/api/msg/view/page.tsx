...
const ApiDocs = () => {
  const endpoints = [
    {
      method: 'GET',
      endpoint: '/api/msg/view',
      description: 'Returns all the messages that was sent to the server',
      queryParams: [
      ...
      response: {
        status: true,
        messages: [
          { message:"Halo", email: 'alice@example.com', time: "2024-11-25-10:54:32" },
          { message:"Hai", email: 'bob@example.com', time: "2024-11-25-13:23:07" },
        ],
      },
    }
  ];
